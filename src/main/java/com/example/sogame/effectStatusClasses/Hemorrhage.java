...
public class Hemorrhage extends StatusEffect {
    public Hemorrhage(int turnLim, EffectSection section, int id, boolean stasisAffected, boolean isPositive, String s) {
