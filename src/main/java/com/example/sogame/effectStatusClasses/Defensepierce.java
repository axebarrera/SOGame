...
public class Defensepierce extends StatusEffect {
    public Defensepierce(int turnLim, EffectSection section, int id, boolean stasisAffected, boolean isPositive, String s) {
