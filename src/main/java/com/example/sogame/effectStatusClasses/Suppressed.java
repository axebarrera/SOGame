...
public class Suppressed extends StatusEffect {
    public Suppressed(int turnLim, EffectSection section, int id, boolean stasisAffected, boolean isPositive, String s) {
