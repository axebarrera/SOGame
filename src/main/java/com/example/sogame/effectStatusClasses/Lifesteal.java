...
public class Lifesteal extends StatusEffect {
    public Lifesteal(int turnLim, EffectSection section, int id, boolean stasisAffected, boolean isPositive, String s) {
