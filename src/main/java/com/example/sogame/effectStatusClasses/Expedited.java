...
public class Expedited extends StatusEffect {
    public Expedited(int turnLim, EffectSection section, int id, boolean stasisAffected, boolean isPositive, String s) {
