...
public class Elementalcharge extends StatusEffect {
    public Elementalcharge(int turnLim, EffectSection section, int id, boolean stasisAffected, boolean isPositive, String s) {
