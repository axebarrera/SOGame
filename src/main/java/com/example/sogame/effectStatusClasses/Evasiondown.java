...
public class Evasiondown extends StatusEffect {
    public Evasiondown(int turnLim, EffectSection section, int id, boolean stasisAffected, boolean isPositive, String s) {
