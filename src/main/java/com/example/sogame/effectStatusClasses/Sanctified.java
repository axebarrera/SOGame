...
public class Sanctified extends StatusEffect {
    public Sanctified(int turnLim, EffectSection section, int id, boolean stasisAffected, boolean isPositive, String s) {
