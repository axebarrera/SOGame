...
public class Evasionup extends StatusEffect {
    public Evasionup(int turnLim, EffectSection section, int id, boolean stasisAffected, boolean isPositive, String s) {
