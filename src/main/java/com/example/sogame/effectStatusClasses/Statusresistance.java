...
public class Statusresistance extends StatusEffect {
    public Statusresistance(int turnLim, EffectSection section, int id, boolean stasisAffected, boolean isPositive, String s) {
