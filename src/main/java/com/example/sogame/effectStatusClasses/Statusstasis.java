...
public class Statusstasis extends StatusEffect {
    public Statusstasis(int turnLim, EffectSection section, int id, boolean stasisAffected, boolean isPositive, String s) {
